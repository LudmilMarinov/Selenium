...
//        // THE ALTERNATIVE OF THE FOREACH ABOVE :D
//        for(int i = 0; i < allOptions.size(); ++i){
//            String currentOptionText = allOptions.get(i).getText();
//            act_options.add(currentOptionText);
//        }
    ...
    // ADDITIONAL MULTIPLE DROPDOWN PICK USING the Actions class
    // One additional way of how to multi select elements from multiple dropDown using the Actions Class
    @Test
    public void multipleSelectTest() {
        ...
        builder
                ...
                .click(driver.findElement(By.cssSelector("select[name='color'] option[value='bl']")))
        ...
        //Verify there 3 options selected in the list
        assertEquals(allColors.getAllSelectedOptions().size(), 3);
        ...
        //Verify expected collection for selected options match with actual options selected
